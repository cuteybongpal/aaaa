	...
	<div class="container">
		<section id="contact" class="contact section">
			<div class="col-lg-12" align="center">
				<form action="./BoardWriteAction.do" name = "newWrite" method="post" onsubmit="return checkForm()">
					...
					<div class="row gy-4">
						...
						<div class="col-md-12">
							...
							<input type="text" class="form-control" name="b_name"
								placeholder="name" value="<%= name %>" id="name">
						</div>
						<div class="col-md-12">
						...
						<div class="col-md-12 text-center">
							<input type="submit" class="btn btn-primary" value="글 게시">
