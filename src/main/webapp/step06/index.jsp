      ...
      <div class="container">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            ...
            <div class="swiper-slide"><img src="../resources/assets/img/clients/client-6.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="../resources/assets/img/clients/client-7.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="../resources/assets/img/clients/client-8.png" class="img-fluid" alt=""></div>
          </div>
        </div>
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
              <div class="portfolio-content h-100">
                <a href="../resources/assets/img/portfolio/app-1.jpg" data-gallery="portfolio-gallery-app" class="glightbox">
                   <img src="../resources/assets/img/product/<%=rs.getString("p_filename")%>" class="img-fluid" alt="">
                </a>
                <div class="portfolio-info">
                  <h4><a href="portfolio-details.html" title="More Details"><%=rs.getString("p_pname")%></a></h4>
                  <p><%=rs.getString("p_description") %></p>
                  <p><%=rs.getString("p_unitPrice")%></p>
                  <p><%=rs.getString("p_condition")%></p>
                  <br />
                  <p>
                     <a href="../ProductAction.do?id=<%=rs.getString("p_productId") %>" class="btn btn-secondary">상세 정보 바로가기 &raquo;</a> 
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <article>
              ...
              <div class="d-flex align-items-center">
                <img src="../resources/assets/img/blog/blog-author.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
